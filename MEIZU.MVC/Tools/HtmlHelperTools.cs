...
namespace MEIZU.Tools
{
    ...
    public static class HtmlHelperTools
    {
        ...
        /// <returns></returns>
        public static HtmlString FormButtonUpload(this HtmlHelper helper,string btnId,string btnName = "上传图片")
        {
            var html = $@"<div class='layui - upload'>
                <button id='" + btnId + @"' class='layui-btn'  type = 'button'>" + btnName + @"</button>
        ...
        public static HtmlString AddresSelect(this HtmlHelper helper)
        {
            var html = @"
